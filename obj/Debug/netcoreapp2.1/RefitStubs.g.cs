...
namespace API_tests
{
    ...
    partial class AutoGeneratedRoomPageInterfaceDeleteRoom : RoomPageInterface.DeleteRoom
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public AutoGeneratedRoomPageInterfaceDeleteRoom(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
        ...
        /// <inheritdoc />
        Task RoomPageInterface.DeleteRoom.DeleteRoom(int gameId)
        {
...
namespace API_tests
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedRoomPageInterfaceNewRoomNameInterface : RoomPageInterface.NewRoomNameInterface
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedRoomPageInterfaceNewRoomNameInterface(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<GameInfo> RoomPageInterface.NewRoomNameInterface.GetRoomInfo(RoomBody name)
        {
...
namespace API_tests
{
    ...
    partial class AutoGeneratedRoomPageInterfaceStoryActions : RoomPageInterface.StoryActions
    {
        ...
        /// <inheritdoc />
        Task<StoryInfo> RoomPageInterface.StoryActions.GetStoryInfo(GameInfo gameId, StoryBody name)
        {
            var arguments = new object[] { gameId, name };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetStoryInfo", new Type[] { typeof(GameInfo), typeof(StoryBody) });
