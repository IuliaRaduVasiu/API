...
namespace API_tests
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedRoomPageInterfaceFinishVoting : RoomPageInterface.FinishVoting
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedRoomPageInterfaceFinishVoting(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task RoomPageInterface.FinishVoting.Finish(FinishVotingBody gameId)
        {
            var arguments = new object[] { gameId };
...
namespace API_tests
{
    ...
    partial class AutoGeneratedRoomPageInterfaceStartVoting : RoomPageInterface.StartVoting
    {
        ...
        /// <inheritdoc />
        Task RoomPageInterface.StartVoting.SelectedCard(VotingBody gameId)
        {
            var arguments = new object[] { gameId };
