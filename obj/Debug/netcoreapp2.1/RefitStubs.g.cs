...
namespace API_tests
{
    ...
    partial class AutoGeneratedDeleteRoom : DeleteRoom
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public AutoGeneratedDeleteRoom(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
        ...
        /// <inheritdoc />
        Task DeleteRoom.DeleteRoom(int gameId)
        {
...
namespace API_tests
{
    ...
    [Preserve]
    [global::System.Reflection.Obfuscation(Exclude=true)]
    partial class AutoGeneratedRoomActions : RoomActions
    {
        /// <inheritdoc />
        public HttpClient Client { get; protected set; }
        readonly IRequestBuilder requestBuilder;
        ...
        /// <inheritdoc />
        public AutoGeneratedRoomActions(HttpClient client, IRequestBuilder requestBuilder)
        {
            Client = client;
            this.requestBuilder = requestBuilder;
        }
        ...
        /// <inheritdoc />
        Task<GameInfo> RoomActions.GetRoomInfo(RoomBody name)
        {
